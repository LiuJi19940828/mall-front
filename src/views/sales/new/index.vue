  ...
  <div class="new_list_container">
    <el-card>
      ...
      <div style="margin-top: 20px">
        <el-form size="small" label-width="140px" inline v-model="new_form">
          <el-form-item label="商品名称：">
            <el-input size="small" placeholder="商品名称" v-model="new_form.name"></el-input>
          </el-form-item>
          <el-form-item label="推荐状态：">
            <el-select v-model="new_form.status" placeholder="全部" size="small">
