  ...
  <div class="subject_list_container">
    <el-card>
      ...
      <div style="margin-top: 20px">
        <el-form size="small" label-width="140px" inline v-model="subject_form">
          <el-form-item label="专题名称：">
            <el-input size="small" placeholder="专题名称" v-model="subject_form.name"></el-input>
          </el-form-item>
          <el-form-item label="推荐状态：">
            <el-select v-model="subject_form.status" placeholder="全部" size="small">
    ...
    <el-card style="margin-top: 20px">
      ...
      <el-button size="small" style="float: right">选择专题</el-button>
    </el-card>
    <div style="margin-top: 20px">
      <el-table
          :data="subject_table"
